; /* /bitrix/js/main/core/core.min.js?155775558576670*/ ; /* /bitrix/js/main/core/core_promise.min.js?15577555852490*/ ; /* /bitrix/js/main/core/core_ajax.min.js?155775558524054*/ ; /* /bitrix/js/main/json/json2.min.js?15577555853467*/ ; /* /bitrix/js/main/core/core_ls.min.js?15577555857365*/ ; /* /bitrix/js/main/core/core_fx.min.js?15577555859768*/ ; /* /bitrix/js/main/session.min.js?15577555852511*/ ; /* /bitrix/js/main/core/core_window.min.js?155775558575671*/ ; /* /bitrix/js/main/date/main.date.min.js?155775558214103*/ ; /* /bitrix/js/main/core/core_popup.min.js?155775558552000*/ ; /* /bitrix/js/main/core/core_date.min.js?155775558524926*/ ; /* /bitrix/js/main/utils.min.js?155775558519858*/

; /* Start:"a:4:{s:4:"full";s:48:"/bitrix/js/main/core/core.min.js?155775558576670";s:6:"source";s:28:"/bitrix/js/main/core/core.js";s:3:"min";s:32:"/bitrix/js/main/core/core.min.js";s:3:"map";s:32:"/bitrix/js/main/core/core.map.js";}"*/
if (typeof WeakMap === "undefined") {
	(function () {
		var e = Date.now() % 1e9;
		var t = function (t) {
			this.name = "__bx" + (Math.random() * 1e9 >>> 0) + e++
		};
		t.prototype = {
			set: function (e, t) {
				if (!this.isValid(e)) {
				...
				if (n && n[0] === e) {
					...
					Object.defineProperty(e, this.name, {
						value: [e, t],
						writable: true
					})
				}
...
if (!Object.values) {
	Object.values = function e(t) {
		var n = [];
		for (var i in t) {
			if (t.hasOwnProperty(i) && t.propertyIsEnumerable(i)) {
				n.push(t[i])
			}
		}
		return n
	...
	if (!!window.BX && !!window.BX.extend) return;
	var _bxtmp;
	if (!!window.BX) {
		_bxtmp = window.BX
	}
	window.BX = function (e, t) {
		if (BX.type.isNotEmptyString(e)) {
			var n;
			if (!!t && null != NODECACHE[e]) n = NODECACHE[e];
			n = n || document.getElementById(e);
			if (!!t) NODECACHE[e] = n;
			return n
		} else if (BX.type.isDomNode(e)) return e;
		else if (BX.type.isFunction(e)) return BX.ready(e);
		return null
	};
	BX.debugEnableFlag = true;
	BX.message = function (e) {
		if (e === "" || typeof e === "string" || e instanceof String) {
			if (typeof BX.message[e] == "undefined" && typeof BX.onCustomEvent !== "undefined") {
	...
	BX.debug = function () {
		if (BX.debugStatus()) {
			...
			if (window.console && window.console.trace) console.trace()
		}
	};
	...
	BX.adjust = function (e, t) {
		...
		if (e.nodeType == 9) e = e.body;
		if (t.attrs) {
			for (n in t.attrs) {
				if (t.attrs.hasOwnProperty(n)) {
					if (n == "class" || n == "className") e.className = t.attrs[n];
					else if (n == "for") e.htmlFor = t.attrs[n];
					else if (t.attrs[n] == "") e.removeAttribute(n);
					else e.setAttribute(n, t.attrs[n])
				}
			}
		}
		if (t.style) {
		...
		if (t.children && t.children.length > 0) {
			for (n = 0, i = t.children.length; n < i; n++) {
				if (BX.type.isNotEmptyString(t.children[n])) e.innerHTML += t.children[n];
				else if (BX.type.isElementNode(t.children[n]) || BX.type.isTextNode(t.children[n])) e.appendChild(t.children[n])
			}
	...
	BX.html = function (e, t, n) {
		if (typeof t == "undefined") return e.innerHTML;
		if (typeof n == "undefined") n = {};
		t = BX.processHTML(t.toString());
		var i = [];
		var r = [];
		if (typeof t.STYLE != "undefined" && t.STYLE.length > 0) {
			for (var o in t.STYLE) i.push(t.STYLE[o])
		}
		if (typeof t.SCRIPT != "undefined" && t.SCRIPT.length > 0) {
			for (var o in t.SCRIPT) {
				if (t.SCRIPT[o].isInternal) r.push(t.SCRIPT[o].JS);
				else i.push(t.SCRIPT[o].JS)
			}
		}
	...
	BX.hasClass = function (e, t) {
		...
		} else return (" " + e.className + " ").indexOf(" " + t + " ") >= 0
	};
	...
	BX.style = function (e, t, n) {
		if (!BX.type.isElementNode(e)) return null;
		if (n == null) {
			var i;
			if (e.currentStyle) i = e.currentStyle[BX.styleIEPropertyName(t)];
	...
	BX.findChild = function (e, t, n, i) {
		...
		for (var s = 0; s < r; s++) {
			...
			if (n == true) {
				...
				if (l) {
					if (i) o = BX.util.array_merge(o, l);
					else return l
				}
			}
		}
		if (i || o.length > 0) return o;
		else return null
	};
	...
	BX.isParentForNode = function (e, t) {
		if (!BX.type.isDomNode(e) || !BX.type.isDomNode(t)) return false;
		while (true) {
			if (e == t) return true;
			if (t && t.parentNode) t = t.parentNode;
			else break
		}
		return false
	};
		...
		if (BX.type.isDomNode(e)) {
			...
			if (BX.type.isArray(e)) {
				...
				for (i = 0, r = e.length; i < r; i++) {
					if (typeof e[i] == "object" && t) n[i] = BX.clone(e[i], t);
					else n[i] = e[i]
				}
			} else {
				n = {};
				if (e.constructor) {
					if (BX.type.isDate(e)) n = new Date(e);
					else n = new e.constructor
				}
				for (i in e) {
					if (typeof e[i] == "object" && t) n[i] = BX.clone(e[i], t);
					else n[i] = e[i]
		...
		for (var n = 0; n < e.length; n++) {
			for (var i in e[n]) {
				...
				if (e[n].hasOwnProperty(i)) {
					if (typeof e[n][i] == "undefined" || e[n][i] == null) continue;
					if (typeof e[n][i] == "object" && !BX.type.isDomNode(e[n][i]) && typeof e[n][i]["isUIWidget"] == "undefined") {
						var r = "length" in e[n][i];
						if (typeof t[i] != "object") t[i] = r ? [] : {};
						if (r) BX.util.array_merge(t[i], e[n][i]);
						else BX.merge(t[i], e[n][i])
					} else t[i] = e[n][i]
				}
			}
		}
	...
	BX.bind = function (e, t, n) {
		...
		if (t === "mousewheel") {
			...
			if (document.cancelFullScreen) BX.bind(e, "fullscreenchange", n);
			else if (document.mozCancelFullScreen) BX.bind(e, "mozfullscreenchange", n);
			else if (document.webkitCancelFullScreen) BX.bind(e, "webkitfullscreenchange", n)
		}
		...
		var i = eventsList.get(e) || {};
		if (!BX.type.isArray(i[t])) {
			i[t] = []
		}
		i[t].push(n);
		eventsList.set(e, i)
	...
	BX.unbind = function (e, t, n) {
		...
		var i = eventsList.get(e);
		if (i && BX.type.isArray(i[t])) {
			i[t] = i[t].filter(function (e) {
				return e !== n
			})
		}
	};
	...
	BX.CaptureEvents = function (e, t) {
		...
		BX.bind = function (n, i, r) {
			if (n === e && i === t) captured_events.push(r);
	...
	function getObjectDelegate(e, t, n, i) {
		...
		var o = r.get(e);
		if (!o) {
			o = i ? i(BX.delegate(e, t)) : BX.delegate(e, t);
			r.set(e, o)
		}
		return o
	}
	BX.bindOnce = function (e, t, n) {
		return BX.bind(e, t, BX.once(e, t, n))
	};
	...
	BX.delegateEvent = function (e, t) {
		return function (n) {
			...
			while (i != this) {
				...
				if (i && i.parentNode) i = i.parentNode;
				else break
			}
			return null
		}
	...
	BX.addCustomEvent = function (e, t, n) {
		...
		if (!BX.type.isFunction(n) || !BX.type.isNotEmptyString(t) || !BX.type.isMapKey(e)) {
			return
		}
		t = t.toLowerCase();
		var i = customEvents.get(e) || {};
		i[t] = BX.type.isArray(i[t]) ? i[t] : [];
		n["__bxSort"] = ++customEventsCnt;
		i[t].push(n);
		customEvents.set(e, i)
	};
	...
	BX.onCustomEvent = function (e, t, n, i) {
		...
		t = t.toLowerCase();
		var r = customEvents.get(window);
		var o = r && BX.type.isArray(r[t]) ? r[t] : [];
		var s = [];
		if (e !== window && BX.type.isMapKey(e)) {
			var a = customEvents.get(e);
			if (a && BX.type.isArray(a[t])) {
				s = a[t]
			}
		}
		var l = o.concat(s);
		...
		l.forEach(function (t) {
			if (o.indexOf(t) !== -1 || s.indexOf(t) !== -1) {
				t.apply(e, i === true ? BX.clone(n) : n)
			}
		})
	};
	...
	BX.ready = function (e) {
		...
		if (!BX.type.isFunction(e)) {
			...
			if (BX.isReady) e.call(document);
			else if (readyList) readyList.push(e)
		}
	};
	...
	BX.browser = {
		...
		DetectIeVersion: function () {
			...
			if (e == -1 || e == 8) {
				...
				if (navigator.appName == "Microsoft Internet Explorer") {
					...
					if (t.exec(navigator.userAgent) != null) e = parseFloat(RegExp.$1)
		...
		DetectAndroidVersion: function () {
			...
			if (e.exec(navigator.userAgent) != null) return parseFloat(RegExp.$1);
			else return 0
		},
		IsDoctype: function (e) {
			e = e || document;
			if (e.compatMode) return e.compatMode == "CSS1Compat";
		...
		isPropertySupported: function (e, t) {
			if (!BX.type.isNotEmptyString(e)) return false;
			...
			function f(e) {
				var t = /(\-([a-z]){1})/g;
				if (t.test(e)) return e.replace(t, function () {
					return arguments[2].toUpperCase()
				});
				else return e
			}
	...
	BX.toggle = function (e, t) {
		if (!t && BX.type.isElementNode(e)) {
			var n = true;
			if (e.BXDISPLAY) n = !_checkDisplay(e);
	...
	BX.util = {
		array_values: function (e) {
			...
			for (var n = 0, i = e.length; n < i; n++)
				if (e[n] !== null && typeof e[n] != "undefined") t.push(e[n]);
			return t
		},
		...
		array_keys: function (e) {
			...
			var t = [];
			for (var n = 0, i = e.length; n < i; n++)
				if (e[n] !== null && typeof e[n] != "undefined") t.push(n);
			return t
		},
		...
		trim: function (e) {
			if (BX.type.isString(e)) return e.replace(r.ltrim, "").replace(r.rtrim, "");
			else return e
		},
		...
		htmlspecialchars: function (e) {
			if (typeof e != "string" || !e.replace) return e;
		...
		jsencode: function (e) {
			...
			for (var n = 0; n < t.length; n++) e = e.replace(new RegExp(t[n].c, "g"), t[n].r);
			return e
		},
		...
		str_pad: function (e, t, n, i) {
			...
			i = i || "right";
			e = e.toString();
			if (i == "left") return BX.util.str_pad_left(e, t, n);
			else return BX.util.str_pad_right(e, t, n)
		},
			...
			for (var n in e) {
				...
				if (BX.type.isArray(i)) {
					i.forEach(function (e, i) {
						t += encodeURIComponent(n + "[" + i + "]") + "=" + encodeURIComponent(e) + "&"
					})
				} else {
	...
	BX.processHTML = function (e, t) {
		...
		while ((n = r.script.exec(e)) !== null) {
			...
			if ((a = n[1].match(r.script_type)) !== null) {
				if (a[1] == "text/html" || a[1] == "text/template") p = true
			}
			if (p) {
		...
		for (var g = 0, X = f.length; g < X; g++) {
			y += e.substr(f[g][0], f[g][1])
		}
		while ((i = y.match(r.style)) !== null) {
	...
	BX.GetContext = function (e) {
		if (BX.type.isElementNode(e)) return e.ownerDocument.parentWindow || e.ownerDocument.defaultView || window;
		else if (BX.type.isDomNode(e)) return e.parentWindow || e.defaultView || window;
		else return window
	};
	...
	BX.align = function (e, t, n, i) {
		...
		if (l.innerWidth + a.scrollLeft - (e["left"] + t) < 0) {
			if (e["right"] - t >= 0) o = e["right"] - t;
			else o = a.scrollLeft
		}
		if (l.innerHeight + a.scrollTop - (e["bottom"] + n) < 0 || ~i.indexOf("top")) {
			if (e["top"] - n >= 0 || ~i.indexOf("top")) s = e["top"] - n;
			else s = a.scrollTop
		}
		return {
			left: o,
	...
	BX.reload = function (e, t) {
		...
		if (r) {
			if (t && (r.substr(0, 5) == "view/" || r.substr(0, 6) == "#view/") && r.indexOf("clear_cache%3DY") < 0) r += (r.indexOf("%3F") == -1 ? "%3F" : "%26") + "clear_cache%3DY";
			n = n.replace(/(\?|\&)_r=[\d]*/, "");
	...
	BX.parseDate = function (e, t, n, i) {
		if (BX.type.isNotEmptyString(e)) {
			if (!n) n = BX.message("FORMAT_DATE");
			if (!i) i = BX.message("FORMAT_DATETIME");
			var r = "";
			for (l = 1; l <= 12; l++) {
			...
			var s = e.match(o),
				a = n.match(/(DD|MI|MMMM|MM|M|YYYY)/gi),
				l, u, f = [],
				c = [],
				d = {};
			if (!s) return null;
			...
			if (d["DD"] > 0 && d["MM"] > 0 && d["YYYY"] > 0) {
				...
				if ((!isNaN(d["HH"]) || !isNaN(d["GG"]) || !isNaN(d["H"]) || !isNaN(d["G"])) && !isNaN(d["MI"])) {
					if (!isNaN(d["H"]) || !isNaN(d["G"])) {
						var B = (d["T"] || d["TT"] || "am").toUpperCase() == "PM";
						var y = parseInt(d["H"] || d["G"] || 0, 10);
						if (B) {
							d["HH"] = y + (y == 12 ? 0 : 12)
						} else {
							d["HH"] = y < 12 ? y : 0
	...
	BX.selectUtils = {
		...
		addSelectedOptions: function (e, t, n, i) {
			...
			var r = e.length;
			for (var o = 0; o < r; o++)
				if (e[o].selected) this.addNewOption(t, e[o].value, e[o].text, i, n)
		},
	...
	BX.hint_replace = function (e, t, n) {
		...
		if (!e || !e.parentNode || !n) return null;
		var i = new BX.CHint({
			hint: n,
			title: t
		});
	...
	BX.CHint.prototype.CreateParent = function (e, t) {
		...
		if (!t) t = {};
		var n = "icon";
		if (t.type && (t.type == "link" || t.type == "icon")) n = t.type;
		if (e) n = "element";
		if (n == "icon") {
			e = BX.create("IMG", {
				props: {
	...
	function bindReady() {
		if (!readyBound) {
			...
			if (document.addEventListener) {
				...
				if (document.documentElement.doScroll && e) doScrollCheck()
			}
		}
		return null
	}
	...
	function runReady() {
		if (!BX.isReady) {
			if (!document.body) return setTimeout(runReady, 15);
			BX.isReady = true;
	...
	function _processTpl(e, t, n) {
		if (e) {
			if (n) e.parentNode.removeChild(e);
			var i = {},
				r = BX.findChildren(e, {
					attribute: "data-role"
				}, true);
				...
				switch (n) {
					...
					case "tagName":
						if (BX.type.isString(t[n])) {
							if (e.tagName.toUpperCase() != t[n].toUpperCase()) return false
						} else if (t[n] instanceof RegExp) {
							if (!t[n].test(e.tagName)) return false
						}
						break;
					case "class":
					case "className":
						if (BX.type.isString(t[n])) {
							if (!BX.hasClass(e, t[n])) return false
						} else if (t[n] instanceof RegExp) {
							if (!BX.type.isString(e.className) || !t[n].test(e.className)) return false
						}
						break;
					case "attr":
					case "attrs":
					case "attribute":
						if (BX.type.isString(t[n])) {
							if (!e.getAttribute(t[n])) return false
						} else if (BX.type.isArray(t[n])) {
							for (i = 0, r = t[n].length; i < r; i++) {
								if (t[n][i] && !e.getAttribute(t[n][i])) return false
							}
						} else {
							for (i in t[n]) {
					...
					case "props":
						if (BX.type.isString(t[n])) {
							...
							for (i = 0, r = t[n].length; i < r; i++) {
								if (t[n][i] && !e[t[n][i]]) return false
							}
						} else {
							for (i in t[n]) {
								if (BX.type.isString(t[n][i])) {
									if (e[i] != t[n][i]) return false
								} else if (t[n][i] instanceof RegExp) {
									if (!BX.type.isString(e[i]) || !t[n][i].test(e[i])) return false
								}
							}
						}
						break;
	...
	BX.DataStorage = function () {
		...
		this.set = function (e, t, n) {
			if (e != document && !BX.type.isElementNode(e) || typeof n == "undefined") return;
	...
	BX.LazyLoad = {
		...
		registerImages: function (e, t, n) {
			if (BX.type.isArray(e)) {
				for (var i = 0, r = e.length; i < r; i++) {
					this.registerImage(e[i], t, n)
				}
			}
		},
	...
	BX.FixFontSize.prototype = {
		...
		onAdaptiveResize: function () {
			...
			if (this.prevWrapperSize > n) this.decrease();
			else if (this.prevWrapperSize < n) this.increase();
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:55:"/bitrix/js/main/core/core_promise.min.js?15577555852490";s:6:"source";s:36:"/bitrix/js/main/core/core_promise.js";s:3:"min";s:40:"/bitrix/js/main/core/core_promise.min.js";s:3:"map";s:40:"/bitrix/js/main/core/core_promise.map.js";}"*/
(function (t) {
	if (!t.BX) {
		t.BX = {}
	}
	var e = t.BX;
	e.Promise = function (t, e) {
		this.state = null;
		this.value = null;
		this.reason = null;
		this.next = null;
	...
	e.Promise.prototype.fulfill = function (t) {
		this.checkState();
		this.value = t;
		this.state = true;
		this.execute()
	};
	e.Promise.prototype.reject = function (t) {
		this.checkState();
		this.reason = t;
		this.state = false;
		this.execute()
	};
	e.Promise.prototype.then = function (t, i) {
		if (typeof t == "function" || t instanceof Function) {
			this.onFulfilled.push(t)
		}
		if (typeof i == "function" || i instanceof Function) {
			this.onRejected.push(i)
		}
		if (this.next === null) {
			this.next = new e.Promise(null, this.ctx)
		}
		if (this.state !== null) {
			this.execute()
		}
	...
	e.Promise.prototype.setAutoResolve = function (t, e) {
		this.timer = setTimeout(function () {
			if (this.state === null) {
				this[t ? "fulfill" : "reject"]()
			}
		}.bind(this), e || 15)
	};
	e.Promise.prototype.cancelAutoResolve = function () {
		clearTimeout(this.timer)
	};
	e.Promise.prototype.resolve = function (t) {
		var e = this;
		if (this === t) {
			this.reject(new TypeError("Promise cannot fulfill or reject itself"))
		} else if (t && t.toString() === "[object BX.Promise]") {
			t.then(function (t) {
				e.fulfill(t)
			}, function (t) {
				e.reject(t)
	...
	e.Promise.prototype.toString = function () {
		return "[object BX.Promise]"
	};
	e.Promise.prototype.execute = function () {
		if (this.state === null) {
			return
		}
		var i = undefined;
		...
		if (this.state === true) {
			if (this.onFulfilled.length) {
				try {
					for (s = 0; s < this.onFulfilled.length; s++) {
						o = this.onFulfilled[s].apply(this.ctx, [this.value]);
			...
			if (this.onRejected.length) {
				try {
					for (s = 0; s < this.onRejected.length; s++) {
						o = this.onRejected[s].apply(this.ctx, [this.reason]);
						if (typeof o != "undefined") {
							i = o
						}
					}
	...
	e.Promise.prototype.checkState = function () {
		if (this.state !== null) {
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:53:"/bitrix/js/main/core/core_ajax.min.js?155775558524054";s:6:"source";s:33:"/bitrix/js/main/core/core_ajax.js";s:3:"min";s:37:"/bitrix/js/main/core/core_ajax.min.js";s:3:"map";s:37:"/bitrix/js/main/core/core_ajax.map.js";}"*/
(function (e) {
	if (e.BX.ajax) return;
	var a = e.BX,
		t = {},
	...
	a.ajax = function (e) {
		...
		for (var n in t)
			if (typeof e[n] == "undefined") e[n] = t[n];
		t = {};
		for (n in r)
			if (typeof e[n] == "undefined") e[n] = r[n];
		e.method = e.method.toUpperCase();
		if (!a.localStorage) e.lsId = null;
		if (a.browser.IsIE()) {
			var u = o.url_utf.exec(e.url);
			if (u) {
				do {
					e.url = e.url.replace(u, a.util.urlencode(u));
					u = o.url_utf.exec(e.url)
				} while (u)
			}
		}
		if (e.dataType == "json") e.emulateOnload = false;
		if (!e.cache && e.method == "GET") e.url = a.ajax._uncache(e.url);
		...
		if (l) {
			...
			if (typeof e.headers == "object") {
				for (n = 0; n < e.headers.length; n++) e.xhr.setRequestHeader(e.headers[n].name, e.headers[n].value)
			}
			if (!!e.onprogress) {
			...
			var p = e.xhr.onreadystatechange = function (t) {
				...
				if (t === "timeout") {
					...
					if (e.xhr.readyState == 4 || t == "run") {
						s = a.ajax.xhrSuccess(e.xhr) ? "success" : "error";
						d = true;
						e.xhr.onreadystatechange = a.DoNothing;
						if (s == "success") {
							...
							if (!!r && r == "Authorize") {
								...
								if (e.lsId) {
									a.localStorage.set("ajax-" + e.lsId, i, e.lsTimeout)
								}
								a.ajax.__run(e, i)
							}
						} else {
	...
	a.ajax.isCrossDomain = function (t, r) {
		...
		s.href = t;
		return s.protocol !== r.protocol || s.hostname !== r.hostname || a.ajax.getHostPort(s.protocol, s.host) !== a.ajax.getHostPort(r.protocol, r.host)
	};
	...
	a.ajax.__prepareOnload = function (t) {
		if (t.length > 0) {
			a.ajax["onload_" + s] = null;
			for (var r = 0, i = t.length; r < i; r++) {
				if (t[r].isInternal) {
					t[r].JS = t[r].JS.replace(o.script_onload, "BX.ajax.onload_" + s)
				}
			}
		}
		a.CaptureEventsGet();
	...
	a.ajax.__runOnload = function () {
		if (null != a.ajax["onload_" + s]) {
			a.ajax["onload_" + s].apply(e);
			a.ajax["onload_" + s] = null
		}
		var t = a.CaptureEventsGet();
		if (t) {
			for (var r = 0; r < t.length; r++) t[r].apply(e)
		}
	};
	...
	a.ajax.processRequestData = function (e, t) {
		...
		switch (t.dataType.toUpperCase()) {
			case "JSON":
				...
				if (!!r && a.type.isArray(r["bxjs"])) {
					for (var o = 0; o < r["bxjs"].length; o++) {
						if (a.type.isNotEmptyString(r["bxjs"][o])) {
							i.push({
								isInternal: false,
								JS: r["bxjs"][o],
		...
		var l = false;
		if (null == s) {
			s = parseInt(Math.random() * 1e6);
			l = true
		}
		if (n.length > 0) a.loadCSS(n);
		if (t.emulateOnload) a.ajax.__prepareOnload(i);
		var c = a.DoNothing;
		if (t.emulateOnload || l) {
			c = a.defer(function () {
				if (t.emulateOnload) a.ajax.__runOnload();
				if (l) s = null;
		...
		try {
			...
			if (t.onfailure) t.onfailure("processing", e);
			a.onCustomEvent(t.xhr, "onAjaxFailure", ["processing", e, t])
		}
	};
	a.ajax.processScripts = function (e, t, r) {
		...
		for (var n = 0, o = e.length; n < o; n++) {
			if (typeof t != "undefined" && t != !!e[n].bRunFirst) continue;
			if (e[n].isInternal) i += ";" + e[n].JS;
			else s.push(e[n].JS)
		}
		s = a.util.array_unique(s);
		var u = i.length > 0 ? function () {
			a.evalGlobal(i)
		} : a.DoNothing;
		if (s.length > 0) {
			a.load(s, function () {
	...
	a.ajax.prepareData = function (e, t) {
		var r = "";
		if (a.type.isString(e)) r = e;
		else if (null != e) {
			for (var s in e) {
				if (e.hasOwnProperty(s)) {
					if (r.length > 0) r += "&";
					var i = a.util.urlencode(s);
					if (t) i = t + "[" + i + "]";
					if (typeof e[s] == "object") r += a.ajax.prepareData(e[s], i);
					else r += i + "=" + a.util.urlencode(e[s])
				}
			}
		}
		return r
	...
	a.ajax.replaceLocalStorageValue = function (e, t, r) {
		if (!!a.localStorage) a.localStorage.set("ajax-" + e, t, r)
	};
	...
	a.ajax.promise = function (e) {
		var t = new a.Promise;
		e.onsuccess = function (e) {
			t.fulfill(e)
		};
		e.onfailure = function (e, a) {
			t.reject({
				reason: e,
				data: a
			})
	...
	a.ajax.loadScriptAjax = function (e, t, r) {
		if (a.type.isArray(e)) {
			for (var s = 0, n = e.length; s < n; s++) {
				a.ajax.loadScriptAjax(e[s], t, r)
			}
		} else {
			var u = e.replace(/\.js\?.*/, ".js");
			if (o.script_self.test(u)) return;
			if (o.script_self_window.test(u) && a.CWindow) return;
			if (o.script_self_admin.test(u) && a.admin) return;
	...
	a.ajax.loadJSON = function (e, t, r, s) {
		if (a.type.isFunction(t)) {
			s = r;
			r = t;
			t = ""
	...
	var u = function (e) {
		...
		if (a.type.isNotEmptyString(e.analyticsLabel)) {
	...
	var l = function (e) {
		e = a.type.isPlainObject(e) ? e : {};
		if (e.data instanceof FormData) {
			e.preparePost = false;
			e.data.append("sessid", a.bitrix_sessid());
			if (a.message.SITE_ID) {
				e.data.append("SITE_ID", a.message.SITE_ID)
			}
			if (typeof e.signedParameters !== "undefined") {
				e.data.append("signedParameters", e.signedParameters)
			}
		} else {
			e.data = a.type.isPlainObject(e.data) ? e.data : {};
			if (a.message.SITE_ID) {
				e.data.SITE_ID = a.message.SITE_ID
			}
			e.data.sessid = a.bitrix_sessid();
			if (typeof e.signedParameters !== "undefined") {
	...
	var c = function (e, t) {
		t = t || false;
		var r = a.clone(e);
		var s = a.ajax.promise(e);
		return s.then(function (e) {
			if (!t && a.type.isPlainObject(e) && a.type.isArray(e.errors)) {
				var s = false;
			...
			if (!a.type.isPlainObject(e) || e.status !== "success") {
				var i = new a.Promise;
				i.reject(e);
				return i
			}
			...
			var t = new a.Promise;
			if (a.type.isPlainObject(e) && e.status && e.hasOwnProperty("data")) {
				t.reject(e)
			} else {
				t.reject({
					status: "error",
	...
	a.ajax.runAction = function (e, t) {
		t = l(t);
		var r = u(t);
		r.action = e;
		var s = "/bitrix/services/main/ajax.php?" + a.ajax.prepareData(r);
		return c({
			method: t.method,
			dataType: "json",
			url: s,
			data: t.data,
			timeout: t.timeout,
			preparePost: t.preparePost,
			headers: t.headers,
			onrequeststart: t.onrequeststart
		})
	};
	a.ajax.runComponentAction = function (e, t, r) {
		r = l(r);
		r.mode = r.mode || "ajax";
		var s = u(r);
		s.c = e;
		s.action = t;
		var i = "/bitrix/services/main/ajax.php?" + a.ajax.prepareData(s);
		return c({
			method: r.method,
			dataType: "json",
			url: i,
	...
	a.ajax.load = function (e, t) {
		if (!a.type.isArray(e)) e = [e];
		var r = 0;
		if (!a.type.isFunction(t)) t = a.DoNothing;
		var s = function (e) {
			if (a.type.isFunction(this.callback)) this.callback(e);
			if (++r >= n) t()
		};
		for (var i = 0, n = e.length; i < n; i++) {
			switch (e[i].type.toUpperCase()) {
				case "SCRIPT":
					a.loadScript([e[i].url], a.proxy(s, e[i]));
					break;
				case "CSS":
					a.loadCSS([e[i].url]);
					if (++r >= n) t();
					break;
				case "JSON":
					a.ajax.loadJSON(e[i].url, a.proxy(s, e[i]));
					break;
				default:
					a.ajax.get(e[i].url, "", a.proxy(s, e[i]));
					break
			}
		}
	};
	...
	a.ajax.submitComponentForm = function (t, r, s) {
		if (!t.target) {
			if (null == t.BXFormTarget) {
				var i = "formTarget_" + Math.random();
		...
		t.BXFormCallback = function (t) {
			...
			a(r).innerHTML = t;
			a.onCustomEvent("onAjaxSuccess", [null, null, i])
		};
	...
	a.ajax.prepareForm = function (e, a) {
		...
		if (!!e) {
			for (t = 0; t < n; t++) {
				...
				switch (s.type.toLowerCase()) {
					...
					case "select-one":
						...
						u += s.name.length + s.value.length;
						break;
					case "file":
						if (!!s.files) {
							for (r = 0; r < s.files.length; r++) {
								o++;
								i.push({
									name: s.name,
									value: s.files[r],
					...
					case "select-multiple":
						for (var l = 0; l < s.options.length; l++) {
							if (s.options[l].selected) {
								i.push({
									name: s.name,
									value: s.options[l].value
								});
								u += s.name.length + s.options[l].length
							}
						}
						break;
					default:
			...
			var c = a,
				f, d, p, h;
			while (t < i.length) {
				var x = i[t].name.indexOf("[");
				if (h) {
					c[i[t].name] = {};
					c[i[t].name][h.replace(/\[|\]/gi, "")] = i[t].value;
					c = a;
					h = null;
					t++
				} else if (x == -1) {
					c[i[t].name] = i[t].value;
					c = a;
					t++
				} else {
					f = i[t].name.substring(0, x);
					d = i[t].name.substring(x + 1);
					p = d.indexOf("]");
					if (p == -1) {
						if (!c[f]) c[f] = [];
						c = a;
						...
						if (!c[f]) c[f] = {};
						c = c[f];
						i[t].name = d.substring(0, p) + d.substring(p + 1)
					}
				}
			}
		}
	...
	a.ajax.submitAjax = function (t, r) {
		...
		if (!e["FormData"]) {
						...
						if (typeof e == "object") {
							for (var r in e) {
								if (e.hasOwnProperty(r)) {
									var s = a.util.urlencode(r);
									if (typeof e[r] == "object" && e[r]["file"] !== true) t[s] = u(e[r]);
									else if (e[r]["file"] === true) t[s] = e[r]["value"];
									else t[s] = a.util.urlencode(e[r])
								}
							}
						} else t = a.util.urlencode(e)
					}
					return t
				},
				l = new e.FormData;
			if (r.method !== "POST") {
				...
				if (r.preparePost === true) r.data = u(r.data);
				o(l, "", r.data);
				r.data = l
			}
			r.preparePost = false;
			r.start = false;
			var c = a.ajax(r);
			if (!!r["onprogress"]) c.upload.addEventListener("progress", function (e) {
				var a = null;
	...
	a.ajax.UpdatePageData = function (e) {
		if (e.TITLE) a.ajax.UpdatePageTitle(e.TITLE);
		if (e.WINDOW_TITLE || e.TITLE) a.ajax.UpdateWindowTitle(e.WINDOW_TITLE || e.TITLE);
		if (e.NAV_CHAIN) a.ajax.UpdatePageNavChain(e.NAV_CHAIN);
		if (e.CSS && e.CSS.length > 0) a.loadCSS(e.CSS);
		if (e.SCRIPTS && e.SCRIPTS.length > 0) {
			var t = function (r, s, i) {
				if (!!s && a.type.isArray(s.scripts)) {
					for (var n = 0, o = e.SCRIPTS.length; n < o; n++) {
						s.scripts.push({
							isInternal: false,
							JS: e.SCRIPTS[n]
						})
	...
	a.ajax.UpdatePageTitle = function (e) {
		...
		if (t) {
			...
			if (!t.firstChild) t.appendChild(document.createTextNode(e));
			else t.insertBefore(document.createTextNode(e), t.firstChild)
		}
	};
	...
	a.userOptions.save = function (e, t, r, s, i) {
		if (null == a.userOptions.options) a.userOptions.options = {};
		i = !!i;
		a.userOptions.options[e + "." + t + "." + r] = [e, t, r, s, i];
		var n = a.userOptions.__get();
		if (n != "") document.cookie = a.message("COOKIE_PREFIX") + "_LAST_SETTINGS=" + encodeURIComponent(n) + "&sessid=" + a.bitrix_sessid() + "; expires=Thu, 31 Dec 2020 23:59:59 GMT; path=/;";
	...
	a.userOptions.send = function (e) {
		...
		if (t != "") {
			document.cookie = a.message("COOKIE_PREFIX") + "_LAST_SETTINGS=; path=/;";
			a.ajax({
				method: "GET",
				dataType: "html",
				processData: false,
	...
	a.userOptions.del = function (e, t, r, s) {
		a.ajax.get(a.userOptions.path + "action=delete&c=" + e + "&n=" + t + (r == true ? "&common=Y" : "") + "&sessid=" + a.bitrix_sessid(), s)
	};
	a.userOptions.__get = function () {
		if (!a.userOptions.options) return "";
		var e = "",
			t = -1,
			r = "",
			s, i;
		for (i in a.userOptions.options) {
			if (a.userOptions.options.hasOwnProperty(i)) {
				s = a.userOptions.options[i];
				if (r != s[0] + "." + s[1]) {
					t++;
					e += "&p[" + t + "][c]=" + a.util.urlencode(s[0]);
					e += "&p[" + t + "][n]=" + a.util.urlencode(s[1]);
					if (s[4] == true) e += "&p[" + t + "][d]=Y";
					r = s[0] + "." + s[1]
				}
				var n = s[2];
				var o = s[3];
				if (n === null) {
					e += "&p[" + t + "][v]=" + a.util.urlencode(o)
				} else {
					e += "&p[" + t + "][v][" + a.util.urlencode(n) + "]=" + a.util.urlencode(o)
				}
			}
		}
		return e.substr(1)
	...
	a.ajax.history = {
		...
		bPushState: !!(history.pushState && a.type.isFunction(history.pushState)),
		startState: null,
		init: function (t) {
			if (a.ajax.history.bInited) return;
			this.obParams = t;
			var r = this.obParams.getState();
			if (a.ajax.history.bPushState) {
				a.ajax.history.expected_hash = e.location.pathname;
				if (e.location.search) a.ajax.history.expected_hash += e.location.search;
				...
				if (!a.ajax.history.expected_hash || a.ajax.history.expected_hash == "#") a.ajax.history.expected_hash = "__bx_no_hash__";
				f.put(a.ajax.history.expected_hash, r);
				a.ajax.history.obTimer = setTimeout(a.ajax.history.__hashListener, 500);
				if (a.browser.IsIE()) {
					...
					a.ajax.history.obFrame.contentWindow.document.write(a.ajax.history.expected_hash);
					...
					a.ajax.history.obImage.setAttribute("src", "javascript:location.href = 'javascript:BX.ajax.history.__hashListener();';")
				}
			}
		...
		__hashListener: function (t) {
			...
			if (a.ajax.history.bPushState) {
				a.ajax.history.obParams.setState(t.state || a.ajax.history.startState)
			} else {
				...
				var r;
				if (null != a.ajax.history.obFrame) r = a.ajax.history.obFrame.contentWindow.document.body.innerText;
				else r = e.location.hash;
				if (!r || r == "#") r = "__bx_no_hash__";
				if (r.indexOf("#") == 0) r = r.substring(1);
				if (r != a.ajax.history.expected_hash) {
					var s = f.get(r);
					if (s) {
						a.ajax.history.obParams.setState(s);
						a.ajax.history.expected_hash = r;
						if (null != a.ajax.history.obFrame) {
							var i = r == "__bx_no_hash__" ? "" : r;
							if (e.location.hash != i && e.location.hash != "#" + i) e.location.hash = i
						}
					}
				}
				a.ajax.history.obTimer = setTimeout(a.ajax.history.__hashListener, 500)
		...
		checkRedirectStart: function (t, r) {
			...
			var i = s.substring(0, 5);
			if (i == "view/" || i == "view%") {
				a.ajax.history.bHashCollision = true;
				document.write("<" + 'div id="__ajax_hash_collision_' + r + '" style="display: none;">')
			}
		},
		checkRedirectFinish: function (t, r) {
			...
			if (s.substring(0, 1) == "#") s = s.substring(1);
			a.ready(function () {
				var e = s.substring(0, 5);
				if (e == "view/" || e == "view%") {
					var i = a("__ajax_hash_collision_" + r);
					var n = i.firstChild;
					a.cleanNode(n);
					i.style.display = "block";
					if (e != "view%") s = a.util.urlencode(s);
					s += (s.indexOf("%3F") == -1 ? "%3F" : "%26") + t + "=" + r;
					var o = "/bitrix/tools/ajax_redirector.php?hash=" + s;
					a.ajax.insertToNode(o, n)
				}
			})
		}
	};
	...
	a.ajax.component.prototype.getState = function () {
		...
		var r = a("navigation");
		if (null != r) t.nav_chain = r.innerHTML;
		a.onCustomEvent(a(t.node), "onComponentAjaxHistoryGetState", [t]);
		return t
	};
	a.ajax.component.prototype.setState = function (e) {
		...
		a.onCustomEvent(a(e.node), "onComponentAjaxHistorySetState", [e])
	};
	var f = {
		arHistory: {},
		put: function (e, a) {
	...
	a.ajax.FormData.prototype.log = function (e) {
		if (false) {
			try {
				if (a.browser.IsIE()) e = JSON.stringify(e);
				console.log(e)
			} catch (e) {}
		}
	};
	a.ajax.FormData.prototype.isSupported = function () {
		var a = {};
		a.fileReader = e.FileReader && e.FileReader.prototype.readAsBinaryString;
	...
	a.ajax.FormData.prototype.send = function (e, t, r, s) {
		this.log("FD send");
		this.xhr = a.ajax({
			method: "POST",
			dataType: "html",
		...
		if (r) {
			this.xhr.upload.addEventListener("progress", function (e) {
				if (e.lengthComputable) r(e.loaded / (e.total || e.totalSize))
			}, false)
		}
		if (this.features.readFormData && this.features.sendFormData) {
			...
			for (var n in this.elements) {
				if (this.elements.hasOwnProperty(n)) i.append(this.elements[n].name, this.elements[n].value)
			}
			for (n in this.files) {
				if (this.files.hasOwnProperty(n)) i.append(this.files[n].name, this.files[n].value)
			}
			this.xhr.send(i)
		}
		return this.xhr
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:48:"/bitrix/js/main/json/json2.min.js?15577555853467";s:6:"source";s:33:"/bitrix/js/main/json/json2.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:50:"/bitrix/js/main/core/core_ls.min.js?15577555857365";s:6:"source";s:31:"/bitrix/js/main/core/core_ls.js";s:3:"min";s:35:"/bitrix/js/main/core/core_ls.min.js";s:3:"map";s:35:"/bitrix/js/main/core/core_ls.map.js";}"*/
(function (e) {
	if (e.BX.localStorage) return;
	var t = e.BX,
		r = null,
		o = null,
		a = "_bxCurrentKey",
	...
	t.localStorage = function () {
		this.keyChanges = {};
		t.bind(t.browser.IsIE() && !t.browser.IsIE9() ? document : e, "storage", t.proxy(this._onchange, this));
	...
	t.localStorage.instance = function () {
		if (!r) {
			...
			if (e == "native") r = new t.localStorage;
			else if (e == "ie8") r = new t.localStorageIE8;
			else if (e == "ie7") r = new t.localStorageIE7;
			else {
				r = {
					set: t.DoNothing,
					get: function () {
	...
	t.localStorage.prototype.prefix = function () {
		if (!o) {
			o = "bx" + t.message("USER_ID") + "-" + (t.message.SITE_ID ? t.message("SITE_ID") : "admin") + "-"
		}
		return o
	};
	t.localStorage.prototype._onchange = function (r) {
		...
		if (!!r.key && r.key.substring(0, this.prefix().length) == this.prefix()) {
			var o = {
				key: r.key.substring(this.prefix().length, r.key.length),
				value: !!r.newValue ? this._decode(r.newValue.substring(11, r.newValue.length)) : null,
				oldValue: !!r.oldValue ? this._decode(r.oldValue.substring(11, r.oldValue.length)) : null
			};
			switch (o.key) {
				case "BXGCE":
					if (o.value) {
					...
					break;
				default:
					if (r.newValue) t.onCustomEvent(e, "onLocalStorageSet", [o]);
					if (r.oldValue && !r.newValue) t.onCustomEvent(e, "onLocalStorageRemove", [o]);
	...
	t.localStorage.prototype._clear = function () {
		...
		for (r = 0; r < localStorage.length; r++) {
			...
			if (t.substring(0, 2) == "bx") {
				...
				if (e >= o) localStorage.removeItem(t)
			}
		}
	};
	...
	t.localStorage.prototype.set = function (e, t, r) {
		if (!r || r <= 0) r = 60;
		if (e == undefined || e == null || t == undefined) return false;
		this.keyChanges[this.prefix() + e] = true;
		try {
			localStorage.setItem(this.prefix() + e, Math.round(+new Date / 1e3) + r + ":" + this._encode(t))
		} catch (o) {
	...
	t.localStorageIE7.prototype._Init = function () {
		...
		var e = this.storage_element.xmlDocument,
			r = e.firstChild.attributes.length;
		for (var o = 0; o < r; o++) {
	...
	t.localStorageIE7.prototype._Listener = function (e) {
		...
		var t = this.storage_element.xmlDocument,
			r = t.firstChild.attributes.length,
			o, a, i;
		var l = {},
			s = [];
		for (o = 0; o < r; o++) {
	...
	t.localStorageIE7.prototype._clear = function () {
		this.storage_element.load(this.NS);
		var e = this.storage_element.xmlDocument,
			t = e.firstChild.attributes.length,
			r = +new Date,
			o, a, i, l;
		for (o = 0; o < t; o++) {
			if (!!e.firstChild.attributes[o]) {
	...
	t.localStorageIE7.prototype.set = function (e, t, r) {
		...
		try {
			...
			this.keyChanges[this.prefix() + e] = true;
			o.firstChild.setAttribute(this.prefix() + e, Math.round(+new Date / 1e3) + r + ":" + this._encode(t));
			this.storage_element.save(this.NS)
		} catch (a) {
	...
	t.onGlobalCustomEvent = function (e, r, o) {
		if (!!t.localStorage.checkBrowser()) t.localStorage.set("BXGCE", {
			e: e,
			p: r
		}, 1);
		if (!o) t.onCustomEvent(e, r)
	};
	try {
	...
	if (i) {
		i = "native";
		var s = t.browser.IsIE() && !t.browser.IsIE9() ? document : e,
			n = function (r) {
				if (typeof (r || e.event).key == "undefined") i = "ie8";
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:50:"/bitrix/js/main/core/core_fx.min.js?15577555859768";s:6:"source";s:31:"/bitrix/js/main/core/core_fx.js";s:3:"min";s:35:"/bitrix/js/main/core/core_fx.min.js";s:3:"map";s:35:"/bitrix/js/main/core/core_fx.map.js";}"*/
(function (t) {
	var i = {
		time: 1,
		step: .05,
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:45:"/bitrix/js/main/session.min.js?15577555852511";s:6:"source";s:26:"/bitrix/js/main/session.js";s:3:"min";s:30:"/bitrix/js/main/session.min.js";s:3:"map";s:30:"/bitrix/js/main/session.map.js";}"*/
function CBXSession() {
	var e = this;
	this.mess = {};
	this.timeout = null;
	...
	this.CheckSession = function () {
		var t = new Date;
		if (t.valueOf() - e.dateCheck.valueOf() < 3e4) return;
		e.activityInterval = Math.round((e.dateInput.valueOf() - e.dateStart.valueOf()) / 1e3);
		e.dateStart.setTime(e.dateInput.valueOf());
		var i = e.activityInterval > e.timeout ? e.timeout - 60 : e.activityInterval;
		var s = {
			method: "GET",
			dataType: "html",
			url: "/bitrix/tools/public_session.php?sessid=" + e.sessid + "&interval=" + i + "&k=" + e.key,
			data: "",
	...
	this.CheckResult = function (t) {
		if (t == "SESSION_EXPIRED") {
			if (e.bShowMess) {
				if (!e.notifier) {
					e.notifier = document.body.appendChild(BX.create("DIV", {
						...
						html: '<a class="bx-session-message-close" style="display:block; width:12px; height:12px; background:url(/bitrix/js/main/core/images/close.gif) center no-repeat; float:right;" href="javascript:bxSession.Close()"></a>' + e.mess.messSessExpired
					}));
					var i = BX.GetWindowScrollPos();
					var s = BX.GetWindowInnerSize();
					e.notifier.style.left = parseInt(i.scrollLeft + s.innerWidth / 2 - parseInt(e.notifier.clientWidth) / 2) + "px";
					if (BX.browser.IsIE()) {
			...
			var n;
			if (t == "SESSION_CHANGED") n = e.timeout - 60;
			else n = e.activityInterval < 60 ? 60 : e.activityInterval > e.timeout ? e.timeout - 60 : e.activityInterval;
			var o = new Date;
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:55:"/bitrix/js/main/core/core_window.min.js?155775558575671";s:6:"source";s:35:"/bitrix/js/main/core/core_window.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function (window) {
	...
	BX.CDialog.prototype.Show = function (t) {
		if (!this.PARAMS.content && this.PARAMS.content_url && BX.ajax && !t) {
			...
			var i = this.PARAMS.zIndex ? this.PARAMS.zIndex : parseInt(BX.style(e, "z-index")) - 1;
			...
			if (this.PARAMS.content_post) {
				s = this.PARAMS.content_post;
				o = "POST"
			}
			var n = this.PARAMS.content_url + (this.PARAMS.content_url.indexOf("?") < 0 ? "?" : "&") + "bxsender=" + this._sender;
			this.auth_callback = BX.delegate(function () {
				this.PARAMS.content = "";
				this.hideNotify();
				this.Show()
	...
	BX.CDialog.prototype.adjustPos = function () {
		if (!this.bExpanded) {
			...
			if (top.BX.SidePanel && top.BX.SidePanel.Instance && top.BX.SidePanel.Instance.getTopSlider()) {
				t = top.BX.SidePanel.Instance.getTopSlider().getWindow()
			}
			var e = t.BX.GetWindowInnerSize();
			var i = t.BX.GetWindowScrollPos();
			var s = {
				left: parseInt(i.scrollLeft + e.innerWidth / 2 - parseInt(this.DIV.offsetWidth) / 2) + "px",
				top: Math.max(parseInt(i.scrollTop + e.innerHeight / 2 - parseInt(this.DIV.offsetHeight) / 2), 0) + "px"
			};
			if (this.PARAMS.zIndex) {
				s["z-index"] = this.PARAMS.zIndex
			}
			BX.adjust(this.DIV, {
				style: s
			})
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:53:"/bitrix/js/main/date/main.date.min.js?155775558214103";s:6:"source";s:33:"/bitrix/js/main/date/main.date.js";s:3:"min";s:37:"/bitrix/js/main/date/main.date.min.js";s:3:"map";s:37:"/bitrix/js/main/date/main.date.map.js";}"*/
(function (e) {
	if (!e.BX) {
		e.BX = {}
	}
	...
	t.Main.Date = {
		...
		format: function (e, t, _, n) {
			var D = this;
			var a = r.isDate(t) ? new Date(t.getTime()) : r.isNumber(t) ? new Date(t * 1e3) : new Date;
			var i = r.isDate(_) ? new Date(_.getTime()) : r.isNumber(_) ? new Date(_ * 1e3) : new Date;
			var o = !!n;
			if (r.isArray(e)) return M(e, a, i, o);
			else if (!r.isNotEmptyString(e)) return "";
			var O = /\\?(sago|iago|isago|Hago|dago|mago|Yago|sdiff|idiff|Hdiff|ddiff|mdiff|Ydiff|sshort|ishort|Hshort|dshort|mhort|Yshort|yesterday|today|tommorow|tomorrow|[a-z])/gi;
			var s = {
				d: function () {
					return r.strPadLeft(g(a).toString(), 2, "0")
				},
				D: function () {
					return D._getMessage("DOW_" + m(a))
				},
				j: function () {
					return g(a)
				},
				l: function () {
					return D._getMessage("DAY_OF_WEEK_" + m(a))
				},
				N: function () {
					return m(a) || 7
				},
				S: function () {
					if (g(a) % 10 == 1 && g(a) != 11) return "st";
					else if (g(a) % 10 == 2 && g(a) != 12) return "nd";
					else if (g(a) % 10 == 3 && g(a) != 13) return "rd";
					else return "th"
				},
				w: function () {
					return m(a)
				...
				z: function () {
					var e = new Date(F(a), 0, 1);
					var t = new Date(F(a), c(a), g(a));
				...
				W: function () {
					...
					var _ = e.getTime();
					H(e, 0, 1);
					if (m(e) != 4) H(e, 0, 1 + (4 - m(e) + 7) % 7);
					var n = 1 + Math.ceil((_ - e) / (7 * 24 * 3600 * 1e3));
					return r.strPadLeft(n.toString(), 2, "0")
				},
				F: function () {
					return D._getMessage("MONTH_" + (c(a) + 1) + "_S")
				},
				f: function () {
					return D._getMessage("MONTH_" + (c(a) + 1))
				},
				m: function () {
					return r.strPadLeft((c(a) + 1).toString(), 2, "0")
				},
				M: function () {
					return D._getMessage("MON_" + (c(a) + 1))
				},
				n: function () {
					return c(a) + 1
				},
				t: function () {
					var e = o ? new Date(Date.UTC(F(a), c(a) + 1, 0)) : new Date(F(a), c(a) + 1, 0);
					return g(e)
				},
				L: function () {
					var e = F(a);
				...
				B: function () {
					var e = (a.getUTCHours() + 1) % 24 + a.getUTCMinutes() / 60 + a.getUTCSeconds() / 3600;
				...
				h: function () {
					return r.strPadLeft((T(a) % 12 || 12).toString(), 2, "0")
				},
				H: function () {
					return r.strPadLeft(T(a).toString(), 2, "0")
				},
				i: function () {
					return r.strPadLeft(E(a).toString(), 2, "0")
				},
				s: function () {
					return r.strPadLeft(A(a).toString(), 2, "0")
				},
				u: function () {
					return r.strPadLeft((l(a) * 1e3).toString(), 6, "0")
				},
				e: function () {
					if (o) return "UTC";
					return ""
				...
				I: function () {
					if (o) return 0;
					var e = new Date(F(a), 0, 1);
					var t = Date.UTC(F(a), 0, 1);
					var r = new Date(F(a), 6, 0);
					var _ = Date.UTC(F(a), 6, 0);
					return 0 + (e - t !== r - _)
				},
				O: function () {
					if (o) return "+0000";
				...
				sshort: function () {
					return D._getMessage("FD_SECOND_SHORT").replace(/#VALUE#/g, I((i - a) / 1e3))
				},
				iago: function () {
					return d(I((i - a) / 60 / 1e3), {
						0: "FD_MINUTE_AGO_0",
						1: "FD_MINUTE_AGO_1",
				...
				ishort: function () {
					return D._getMessage("FD_MINUTE_SHORT").replace(/#VALUE#/g, I((i - a) / 60 / 1e3))
				},
				Hago: function () {
					return d(I((i - a) / 60 / 60 / 1e3), {
						0: "FD_HOUR_AGO_0",
						1: "FD_HOUR_AGO_1",
				...
				Hshort: function () {
					return D._getMessage("FD_HOUR_SHORT").replace(/#VALUE#/g, I((i - a) / 60 / 60 / 1e3))
				},
				yesterday: function () {
					return D._getMessage("FD_YESTERDAY")
				},
				today: function () {
					return D._getMessage("FD_TODAY")
				},
				tommorow: function () {
					return D._getMessage("FD_TOMORROW")
				},
				tomorrow: function () {
					return D._getMessage("FD_TOMORROW")
				},
				dago: function () {
					return d(I((i - a) / 60 / 60 / 24 / 1e3), {
						0: "FD_DAY_AGO_0",
						1: "FD_DAY_AGO_1",
				...
				dshort: function () {
					return D._getMessage("FD_DAY_SHORT").replace(/#VALUE#/g, I((i - a) / 60 / 60 / 24 / 1e3))
				},
				mago: function () {
					return d(I((i - a) / 60 / 60 / 24 / 31 / 1e3), {
						0: "FD_MONTH_AGO_0",
						1: "FD_MONTH_AGO_1",
				...
				mshort: function () {
					return D._getMessage("FD_MONTH_SHORT").replace(/#VALUE#/g, I((i - a) / 60 / 60 / 24 / 31 / 1e3))
				},
				Yago: function () {
					return d(I((i - a) / 60 / 60 / 24 / 365 / 1e3), {
						0: "FD_YEARS_AGO_0",
						1: "FD_YEARS_AGO_1",
				...
				x: function () {
					var e = D.isAmPmMode(true);
					var t = e === D.AM_PM_MODE.LOWER ? "g:i a" : e === D.AM_PM_MODE.UPPER ? "g:i A" : "H:i";
					return D.format([
						["tomorrow", "tomorrow, " + t],
						["-", D.convertBitrixFormat(D._getMessage("FORMAT_DATETIME")).replace(/:s/g, "")],
						["s", "sago"],
						["i", "iago"],
						["today", "today, " + t],
				...
				X: function () {
					...
					var r = D.format([
						["tomorrow", "tomorrow"],
						["-", D.convertBitrixFormat(D._getMessage("FORMAT_DATE"))],
						["today", "today"],
						["yesterday", "yesterday"],
						["", D.convertBitrixFormat(D._getMessage("FORMAT_DATE"))]
					], a, i, o);
					...
					if (_.length > 0) return D._getMessage("FD_DAY_AT_TIME").replace(/#DAY#/g, r).replace(/#TIME#/g, _);
					else return r
				},
				Q: function () {
					var e = I((i - a) / 60 / 60 / 24 / 1e3);
					if (e == 0) return D._getMessage("FD_DAY_DIFF_1").replace(/#VALUE#/g, 1);
					else return D.format([
						["d", "ddiff"],
						["m", "mdiff"],
						["", "Ydiff"]
					], a, i)
			...
			var f = e.replace(O, S);
			if (u) {
				f = f.replace(/\s*00:00:00\s*/g, "").replace(/(\d\d:\d\d)(:00)/g, "$1").replace(/(\s*00:00\s*)(?!:)/g, "")
			}
			return f;
			...
			function M(e, t, r, _) {
				...
				for (var a = 0; a < e.length; a++) {
					...
					var O = null;
					if (i == "s") {
						if (n < 60) return D.format(o, t, r, _)
					} else if ((O = /^s(\d+)\>?(\d+)?/.exec(i)) != null) {
						if (O[1] && O[2]) {
							if (n < O[1] && n > O[2]) {
								return D.format(o, t, r, _)
							}
						} else if (n < O[1]) {
							return D.format(o, t, r, _)
						}
					} else if (i == "i") {
						if (n < 60 * 60) return D.format(o, t, r, _)
						...
						if (n < 24 * 60 * 60) return D.format(o, t, r, _)
						...
						if (n < 31 * 24 * 60 * 60) return D.format(o, t, r, _)
						...
						if (n < 365 * 24 * 60 * 60) return D.format(o, t, r, _)
						...
						var s = F(r),
							u = c(r),
							f = g(r);
						var M = _ ? new Date(Date.UTC(s, u, f, 0, 0, 0, 0)) : new Date(s, u, f, 0, 0, 0, 0);
						var T = _ ? new Date(Date.UTC(s, u, f + 1, 0, 0, 0, 0)) : new Date(s, u, f + 1, 0, 0, 0, 0);
						if (t >= M && t < T) return D.format(o, t, r, _)
						...
						u = c(r);
						f = g(r);
						var E = _ ? new Date(Date.UTC(s, u, f - 1, 0, 0, 0, 0)) : new Date(s, u, f - 1, 0, 0, 0, 0);
						var A = _ ? new Date(Date.UTC(s, u, f, 0, 0, 0, 0)) : new Date(s, u, f, 0, 0, 0, 0);
						if (t >= E && t < A) return D.format(o, t, r, _)
					} else if (i == "tommorow" || i == "tomorrow") {
						s = F(r);
						u = c(r);
						f = g(r);
						var l = _ ? new Date(Date.UTC(s, u, f + 1, 0, 0, 0, 0)) : new Date(s, u, f + 1, 0, 0, 0, 0);
						var m = _ ? new Date(Date.UTC(s, u, f + 2, 0, 0, 0, 0)) : new Date(s, u, f + 2, 0, 0, 0, 0);
						if (t >= l && t < m) return D.format(o, t, r, _)
					} else if (i == "-") {
						if (n < 0) return D.format(o, t, r, _)
					}
				}
				return e.length > 0 ? D.format(e[e.length - 1][1], t, r, _) : ""
			}
			...
			function c(e) {
				return o ? e.getUTCMonth() : e.getMonth()
			}

			function T(e) {
				return o ? e.getUTCHours() : e.getHours()
			}

			function E(e) {
				return o ? e.getUTCMinutes() : e.getMinutes()
			}

			function A(e) {
				return o ? e.getUTCSeconds() : e.getSeconds()
			}

			function l(e) {
				return o ? e.getUTCMilliseconds() : e.getMilliseconds()
			}

			function m(e) {
				return o ? e.getUTCDay() : e.getDay()
			}

			function R(e, t) {
				return o ? e.setUTCDate(t) : e.setDate(t)
			}

			function H(e, t, r) {
				return o ? e.setUTCMonth(t, r) : e.setMonth(t, r)
			}
			...
			function d(e, t) {
				...
				var _ = r % 10;
				var n = "";
				if (r == 0) n = D._getMessage(t["0"]);
				else if (r == 1) n = D._getMessage(t["1"]);
				else if (r >= 10 && r <= 20) n = D._getMessage(t["10_20"]);
				else if (_ == 1) n = D._getMessage(t["MOD_1"]);
				else if (2 <= _ && _ <= 4) n = D._getMessage(t["MOD_2_4"]);
				else n = D._getMessage(t["MOD_OTHER"]);
		...
		formatLastActivityDate: function (e, t, r) {
			...
			var a = this.format(D, e, t, r);
			if ((match = /^#(\d+)#(.*)/.exec(a)) != null) {
				switch (match[1]) {
					case "01":
						a = this._getMessage("FD_LAST_SEEN_TOMORROW").replace("#TIME#", match[2]);
						break;
					case "02":
						a = this._getMessage("FD_LAST_SEEN_NOW");
						break;
					case "03":
						a = this._getMessage("FD_LAST_SEEN_TODAY").replace("#TIME#", match[2]);
						break;
					case "04":
						a = this._getMessage("FD_LAST_SEEN_YESTERDAY").replace("#TIME#", match[2]);
						break;
					case "05":
						a = this._getMessage("FD_LAST_SEEN_MORE_YEAR");
						break;
					default:
						a = match[2];
						break
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:54:"/bitrix/js/main/core/core_popup.min.js?155775558552000";s:6:"source";s:34:"/bitrix/js/main/core/core_popup.js";s:3:"min";s:38:"/bitrix/js/main/core/core_popup.min.js";s:3:"map";s:38:"/bitrix/js/main/core/core_popup.map.js";}"*/
(function (t) {
	"use strict";
	...
	BX.PopupWindowManager = {
		...
		create: function (t, e, i) {
			var n = t;
			if (BX.type.isPlainObject(t) && !e && !i) {
				n = t.id;
				if (!BX.type.isNotEmptyString(n)) {
					throw new Error("BX.PopupWindowManager: 'id' parameter is required.")
				}
			}
			var o = this.getPopupById(n);
			if (o === null) {
				o = new BX.PopupWindow(t, e, i);
				BX.addCustomEvent(o, "onPopupShow", BX.delegate(this.onPopupShow, this));
				BX.addCustomEvent(o, "onPopupClose", BX.delegate(this.onPopupClose, this))
			}
			return o
		},
		...
		isAnyPopupShown: function () {
			for (var t = 0, e = this._popups.length; t < e; t++) {
				if (this._popups[t].isShown()) {
					return true
				}
			}
			return false
		},
		getPopupById: function (t) {
			for (var e = 0; e < this._popups.length; e++) {
				if (this._popups[e].getId() === t) {
					return this._popups[e]
				}
			}
			return null
		},
	...
	BX.PopupWindow = function (e, i, n) {
		this.compatibleMode = n && BX.type.isBoolean(n.compatibleMode) ? n.compatibleMode : true;
		if (BX.type.isPlainObject(e) && !i && !n) {
			n = e;
			e = n.id;
			i = n.bindElement;
		...
		this.params = n;
		if (!BX.type.isNotEmptyString(e)) {
			e = "popup-window-" + BX.util.getRandomString().toLowerCase()
		}
		BX.onCustomEvent("onPopupWindowInit", [e, i, n]);
		this.uniquePopupId = e;
		this.params.zIndex = BX.type.isNumber(n.zIndex) ? parseInt(n.zIndex) : 0;
		this.params.zIndexAbsolute = BX.type.isNumber(n.zIndexAbsolute) ? parseInt(n.zIndexAbsolute) : 0;
		this.buttons = n.buttons && BX.type.isArray(n.buttons) ? n.buttons : [];
		...
		this.overlay = null;
		this.titleBar = null;
		this.bindOptions = typeof n.bindOptions === "object" ? n.bindOptions : {};
		this.autoHide = n.autoHide === true;
		this.autoHideHandler = BX.type.isFunction(n.autoHideHandler) ? n.autoHideHandler : null;
		this.handleAutoHide = this.handleAutoHide.bind(this);
		this.handleOverlayClick = this.handleOverlayClick.bind(this);
		this.isAutoHideBinded = false;
		this.closeByEsc = n.closeByEsc === true;
		...
		if (n.events) {
			for (var o in n.events) {
				BX.addCustomEvent(this, o, n.events[o])
			}
		}
		var s = "popup-window";
		if (n.contentColor && BX.type.isNotEmptyString(n.contentColor)) {
			s += " popup-window-content-" + n.contentColor
		}
		if (n.titleBar) {
			s += " popup-window-with-titlebar"
		}
		if (n.className && BX.type.isNotEmptyString(n.className)) {
			s += " " + n.className
		}
		if (n.darkMode) {
			s += " popup-window-dark"
		...
		if (n.closeIcon) {
			this.closeIcon = BX.create("span", {
				props: {
					className: "popup-window-close-icon" + (n.titleBar ? " popup-window-titlebar-close-icon" : "")
				},
				style: typeof n.closeIcon === "object" ? n.closeIcon : {},
				events: {
					click: BX.proxy(this.handleCloseIconClick, this)
				}
			});
			if (BX.browser.IsIE()) {
		...
		if (n.overlay) {
			this.setOverlay(n.overlay)
		}
		this.setOffset(n);
		this.setBindElement(i);
		this.setTitleBar(n.titleBar);
		this.setContent(n.content);
		this.setButtons(n.buttons);
		this.setWidth(n.width);
		this.setHeight(n.height);
		this.setMinWidth(n.minWidth);
		this.setMinHeight(n.minHeight);
		this.setMaxWidth(n.maxWidth);
		this.setMaxHeight(n.maxHeight);
		this.setResizeMode(n.resizable);
		this.setPadding(n.padding);
		this.setContentPadding(n.contentPadding);
		this.setBackground(n.background);
		this.setContentBackground(n.contentBackground);
		this.setAnimation(n.animation);
		this.setCacheable(n.cacheable);
		if (n.contentNoPaddings) {
		...
		if (n.bindOnResize !== false) {
			BX.bind(t, "resize", this.handleResizeWindow)
		}
	...
	BX.PopupWindow.prototype.setContent = function (t) {
		...
		if (BX.type.isElementNode(t)) {
			...
			var e = BX.type.isDomNode(t.parentNode);
			this.contentContainer.appendChild(t);
			if (this.isCompatibleMode() || e) {
				t.style.display = "block"
			}
		} else if (BX.type.isString(t)) {
	...
	BX.PopupWindow.prototype.setButtons = function (t) {
		...
		if (this.buttons.length > 0 && this.contentContainer) {
			...
			for (var i = 0; i < this.buttons.length; i++) {
				...
				if (n instanceof BX.PopupWindowButton) {
					n.popupWindow = this;
					e.push(n.render())
				} else if (n instanceof BX.UI.Button) {
					n.setContext(this);
					e.push(n.render())
				}
			}
	...
	BX.PopupWindow.prototype.getBindElementPos = function (t) {
		if (BX.type.isDomNode(t)) {
			...
			var e = BX.GetWindowInnerSize();
			var i = BX.GetWindowScrollPos();
			var n = this.getPopupContainer().offsetWidth;
			var o = this.getPopupContainer().offsetHeight;
			this.bindOptions.forceTop = true;
			return {
				left: e.innerWidth / 2 - n / 2 + i.scrollLeft,
				top: e.innerHeight / 2 - o / 2 + i.scrollTop,
				bottom: e.innerHeight / 2 - o / 2 + i.scrollTop,
				windowSize: e,
				windowScroll: i,
				popupWidth: n,
				popupHeight: o
	...
	BX.PopupWindow.prototype.setAngle = function (t) {
		...
		if (this.angle === null) {
			...
			var n = BX.PopupWindow.getOption(i === "top" ? "angleMinTop" : "angleMinBottom");
			var o = BX.type.isNumber(t.offset) ? t.offset : 0;
			var s = BX.PopupWindow.getOption("angleLeftOffset", null);
			if (o > 0 && BX.type.isNumber(s)) {
				o += s - BX.PopupWindow.defaultOptions.angleLeftOffset
			}
			this.angle = {
		...
		if (typeof t === "object" && BX.type.isNumber(t.offset)) {
			...
			if (this.angle.position === "top") {
				...
				a = this.getPopupContainer().offsetWidth - BX.PopupWindow.getOption("angleMaxTop");
				a = a < u ? Math.max(u, p) : a;
				this.angle.offset = Math.min(Math.max(u, p), a);
				this.angle.element.style.left = this.angle.offset + "px";
				this.angle.element.style.marginLeft = 0
			} else if (this.angle.position === "bottom") {
				u = BX.PopupWindow.getOption("angleMinBottom");
				a = this.getPopupContainer().offsetWidth - BX.PopupWindow.getOption("angleMaxBottom");
				a = a < u ? Math.max(u, p) : a;
				this.angle.offset = Math.min(Math.max(u, p), a);
				...
				a = this.getPopupContainer().offsetHeight - BX.PopupWindow.getOption("angleMaxRight");
				a = a < u ? Math.max(u, p) : a;
				this.angle.offset = Math.min(Math.max(u, p), a);
				this.angle.element.style.top = this.angle.offset + "px"
			} else if (this.angle.position === "left") {
				u = BX.PopupWindow.getOption("angleMinLeft");
				a = this.getPopupContainer().offsetHeight - BX.PopupWindow.getOption("angleMaxLeft");
				a = a < u ? Math.max(u, p) : a;
				this.angle.offset = Math.min(Math.max(u, p), a);
				this.angle.element.style.top = this.angle.offset + "px"
			}
	...
	BX.PopupWindow.prototype.setWidth = function (t) {
		this.setWidthProperty("width", t)
	};
	BX.PopupWindow.prototype.getHeight = function () {
		return this.height
	};
	BX.PopupWindow.prototype.setHeight = function (t) {
		this.setHeightProperty("height", t)
	};
	BX.PopupWindow.prototype.getMinWidth = function () {
		return this.minWidth
	};
	BX.PopupWindow.prototype.setMinWidth = function (t) {
		this.setWidthProperty("minWidth", t)
	};
	BX.PopupWindow.prototype.getMinHeight = function () {
		return this.minHeight
	};
	BX.PopupWindow.prototype.setMinHeight = function (t) {
		this.setHeightProperty("minHeight", t)
	};
	BX.PopupWindow.prototype.getMaxWidth = function () {
		return this.maxWidth
	};
	BX.PopupWindow.prototype.setMaxWidth = function (t) {
		this.setWidthProperty("maxWidth", t)
	};
	BX.PopupWindow.prototype.getMaxHeight = function () {
		return this.maxHeight
	};
	BX.PopupWindow.prototype.setMaxHeight = function (t) {
		this.setHeightProperty("maxHeight", t)
	};
	BX.PopupWindow.prototype.setWidthProperty = function (t, e) {
		var i = ["width", "minWidth", "maxWidth"];
		if (i.indexOf(t) === -1) {
			return
		}
		if (BX.type.isNumber(e) && e >= 0) {
			this[t] = e;
			this.getResizableContainer().style[t] = e + "px";
			this.getContentContainer().style.overflowX = "auto";
			this.getPopupContainer().classList.add("popup-window-fixed-width");
			if (this.getTitleContainer() && BX.browser.IsIE11()) {
				this.getTitleContainer().style[t] = e + "px"
			}
		} else if (e === null || e === false) {
			this[t] = null;
			this.getResizableContainer().style.removeProperty(BX.util.getCssName(t));
			var n = i.some(function (t) {
				return this.getResizableContainer().style.getPropertyValue(BX.util.getCssName(t)) !== ""
			}, this);
			if (!n) {
			...
			if (this.getTitleContainer() && BX.browser.IsIE11()) {
				this.getTitleContainer().style.removeProperty(BX.util.getCssName(t))
			}
		}
	};
	BX.PopupWindow.prototype.setHeightProperty = function (t, e) {
		var i = ["height", "minHeight", "maxHeight"];
		if (i.indexOf(t) === -1) {
			return
		}
		if (BX.type.isNumber(e) && e >= 0) {
	...
	BX.PopupWindow.prototype.setPadding = function (t) {
		if (BX.type.isNumber(t) && t >= 0) {
			this.padding = t;
			this.getPopupContainer().style.padding = t + "px"
		} else if (t === null) {
			this.padding = null;
	...
	BX.PopupWindow.prototype.setContentPadding = function (t) {
		if (BX.type.isNumber(t) && t >= 0) {
			this.contentPadding = t;
			this.getContentContainer().style.padding = t + "px"
		} else if (t === null) {
			this.contentPadding = null;
	...
	BX.PopupWindow.prototype.setBackground = function (t) {
		if (BX.type.isNotEmptyString(t)) {
			this.background = t;
			this.getPopupContainer().style.background = t
		} else if (t === null) {
			this.background = null;
	...
	BX.PopupWindow.prototype.setContentBackground = function (t) {
		if (BX.type.isNotEmptyString(t)) {
			this.contentBackground = t;
			this.getContentContainer().style.background = t
		} else if (t === null) {
			this.contentBackground = null;
	...
	BX.PopupWindow.prototype.setCacheable = function (t) {
		this.cacheable = t !== false
	};
	...
	BX.PopupWindow.prototype._resize = function (t, e, i, n) {
		var o = i - this.resizeContentPos.left;
		var s = n - this.resizeContentPos.top;
		var p = BX.GetWindowScrollSize().scrollWidth;
		if (this.resizeContentPos.left + o + this.resizeContentOffset >= p) {
			o = p - this.resizeContentPos.left - this.resizeContentOffset
		}
		o = Math.max(o, this.getMinWidth());
		s = Math.max(s, this.getMinHeight());
		if (this.getMaxWidth() !== null) {
			o = Math.min(o, this.getMaxWidth())
		}
		if (this.getMaxHeight() !== null) {
			s = Math.min(s, this.getMaxHeight())
		}
		this.setWidth(o);
		this.setHeight(s)
	};
	...
	BX.PopupWindow.prototype.handleAutoHide = function (t) {
		if (this.isDestroyed()) {
			return
		}
		if (this.autoHideHandler !== null) {
			if (this.autoHideHandler(t)) {
				this._tryCloseByEvent(t)
			}
		} else if (t.target !== this.getPopupContainer() && !this.getPopupContainer().contains(t.target)) {
			this._tryCloseByEvent(t)
		}
	};
	BX.PopupWindow.prototype._tryCloseByEvent = function (t) {
		if (this.isCompatibleMode()) {
			this.tryCloseByEvent(t)
		} else {
			setTimeout(BX.proxy(this.tryCloseByEvent, this), 0, t)
		}
	};
	BX.PopupWindow.prototype.handleOverlayClick = function (t) {
		this.tryCloseByEvent(t);
		t.stopPropagation()
	};
	...
	BX.PopupWindow.prototype.showOverlay = function () {
		if (this.overlay !== null && this.overlay.element !== null) {
			...
			var t = this.getPopupContainer().offsetHeight;
			this.overlayTimeout = setInterval(function () {
				if (t !== this.getPopupContainer().offsetHeight) {
					this.resizeOverlay();
					t = this.getPopupContainer().offsetHeight
				}
			}.bind(this), 1e3)
		}
	};
	...
	BX.PopupWindow.prototype.animateOpening = function (t) {
		...
		if (this.animationShowClassName !== null) {
			...
			if (this.animationCloseEventType !== null) {
				var e = this.animationCloseEventType + "end";
				this.getPopupContainer().addEventListener(e, function i() {
	...
	BX.PopupWindow.prototype.animateClosing = function (t) {
		BX.removeClass(this.getPopupContainer(), this.animationShowClassName);
	...
	BX.PopupWindow.prototype.tryCloseByEvent = function (t) {
		if (this.isLeftButton(t)) {
			this.close()
		}
	};
	BX.PopupWindow.prototype.setAnimation = function (t) {
		if (BX.type.isPlainObject(t)) {
			this.animationShowClassName = BX.type.isNotEmptyString(t.showClassName) ? t.showClassName : null;
			this.animationCloseClassName = BX.type.isNotEmptyString(t.closeClassName) ? t.closeClassName : null;
			this.animationCloseEventType = BX.util.in_array(t.closeAnimationType, ["animation", "transition"]) ? t.closeAnimationType : null
		} else if (BX.type.isNotEmptyString(t)) {
			var e = t;
			if (e === "fading") {
	...
	BX.PopupWindow.prototype.handleCloseIconClick = function (t) {
		this.tryCloseByEvent(t);
		t.stopPropagation()
	};
	BX.PopupWindow.prototype.isLeftButton = function (t) {
		return t.button === 0
	};
	BX.PopupWindow.prototype.handleDocumentKeyUp = function (e) {
		e = e || t.event;
		if (e.keyCode === 27) {
			n(this.getZindex(), BX.proxy(this.close, this))
		}
	};
	BX.PopupWindow.prototype.destroy = function () {
		...
		BX.unbind(t, "resize", this.handleResizeWindow);
	...
	BX.PopupWindow.prototype.adjustPosition = function (t) {
		...
		var n = e.windowScroll ? e.windowScroll : BX.GetWindowScrollPos();
		var o = e.popupWidth ? e.popupWidth : this.popupContainer.offsetWidth;
		...
		if (!this.bindOptions.forceLeft && u + o + this.bordersWidth >= i.innerWidth + n.scrollLeft && i.innerWidth + n.scrollLeft - o - this.bordersWidth > 0) {
			var a = u;
			u = i.innerWidth + n.scrollLeft - o - this.bordersWidth;
			if (this.isTopOrBottomAngle()) {
				this.setAngle({
					offset: a - u + this.angle.defaultOffset
				})
			}
		...
		if (this.bindOptions.position && this.bindOptions.position === "top") {
			r = this.bindElementPos.top - s - this.offsetTop - (this.isBottomAngle() ? p : 0);
			if (r < 0 || !this.bindOptions.forceTop && r < n.scrollTop) {
			...
			r = this.bindElementPos.bottom + this.offsetTop + this.getAngleHeight();
			if (!this.bindOptions.forceTop && r + s > i.innerHeight + n.scrollTop && this.bindElementPos.top - s - this.getAngleHeight() >= 0) {
	...
	BX.PopupWindow.prototype.handleResizeWindow = function (t) {
		if (this.isShown()) {
			this.adjustPosition();
			if (this.overlay !== null) {
				this.resizeOverlay()
	...
	BX.PopupWindow.prototype.move = function (t, e, i, n) {
		...
		if (typeof this.params.draggable === "object" && this.params.draggable.restrict) {
			...
			var a = this.popupContainer.offsetHeight;
			if (o > p.scrollWidth - u) {
				o = p.scrollWidth - u
			}
			if (s > p.scrollHeight - a) {
				s = p.scrollHeight - a
			}
			if (s < 0) {
				s = 0
	...
	BX.PopupMenu = {
		...
		create: function (t) {
			...
			var n = arguments[2];
			var o = arguments[3];
			if (BX.type.isPlainObject(t) && !i && !n && !o) {
				e = t.id;
				if (!BX.type.isNotEmptyString(e)) {
			...
			if (!this.Data[e]) {
				this.Data[e] = new BX.PopupMenuWindow(t, i, n, o);
				BX.addCustomEvent(this.Data[e], "onPopupMenuDestroy", this.onPopupDestroy.bind(this))
			}
			return this.Data[e]
		},
	...
	BX.PopupMenuWindow = function (t, e, i, n) {
		if (BX.type.isPlainObject(t) && !e && !i && !n) {
			n = t;
			n.compatibleMode = false;
			t = n.id;
			e = n.bindElement;
			i = n.items;
			if (!BX.type.isNotEmptyString(t)) {
				t = "menu-popup-" + BX.util.getRandomString().toLowerCase()
			}
		}
		this.id = t;
		this.bindElement = e;
		...
		this.params = n && typeof n === "object" ? n : {};
		this.parentMenuWindow = null;
		this.parentMenuItem = null;
		if (i && BX.type.isArray(i)) {
			for (var o = 0; o < i.length; o++) {
				this.addMenuItemInternal(i[o], null)
			}
		}
		this.layout = {
			menuContainer: null,
	...
	BX.PopupMenuWindow.prototype.__createPopup = function () {
		...
		var s = BX.mergeEx(o, this.params);
		s.noAllPaddings = true;
		s.darkMode = false;
		s.autoHideHandler = this.handleAutoHide.bind(this);
		s.content = this.layout.menuContainer = BX.create("div", {
			props: {
		...
		var p = s.compatibleMode === false ? this.getId() : "menu-popup-" + this.getId();
		var u = new BX.PopupWindow(p, this.bindElement, s);
		if (this.params && this.params.events) {
			for (var a in this.params.events) {
				if (this.params.events.hasOwnProperty(a)) {
					BX.addCustomEvent(u, a, this.params.events[a])
				}
			}
		}
		return u
	...
	BX.PopupMenuWindow.prototype.handleAutoHide = function (t) {
		return !this.containsTarget(t.target)
	};
	BX.PopupMenuWindow.prototype.containsTarget = function (t) {
		var e = this.getPopupWindow().getPopupContainer();
		if (this.getPopupWindow().isShown() && (t === e || e.contains(t))) {
			return true
		}
		return this.getMenuItems().some(function (e) {
			return e.getSubMenu() && e.getSubMenu().containsTarget(t)
		})
	};
	...
	BX.PopupMenuWindow.prototype.getRootMenuWindow = function () {
		var t = null;
		var e = this.getParentMenuWindow();
		while (e !== null) {
			t = e;
			e = e.getParentMenuWindow()
		}
		return t
	};
	...
	BX.PopupMenuWindow.prototype.addMenuItem = function (t, e) {
		...
		var n = i.getLayout();
		var o = this.getMenuItem(e);
		if (o !== null) {
			var s = o.getLayout();
			this.itemsContainer.insertBefore(n.item, s.item)
		} else {
			this.itemsContainer.appendChild(n.item)
		}
		return i
	};
	BX.PopupMenuWindow.prototype.addMenuItemInternal = function (t, e) {
		...
		var n = this.getMenuItemPosition(e);
		if (n >= 0) {
			this.menuItems = BX.util.insertIntoArray(this.menuItems, n, i)
		} else {
	...
	BX.PopupMenuWindow.prototype.removeMenuItem = function (t) {
		...
		if (!this.menuItems.length) {
			var n = e.getMenuWindow();
			if (n) {
				var o = n.getParentMenuItem();
				if (o) {
					o.destroySubMenu()
				} else {
					n.destroy()
	...
	BX.PopupMenuItem = function (t) {
		...
		this.disabled = t.disabled === true;
		this.cacheable = t.cacheable === true;
	...
	BX.PopupMenuItem.prototype = {
			...
			if (this.delimiter) {
				if (BX.type.isNotEmptyString(this.text)) {
					this.layout.item = BX.create("span", {
						...
						children: [this.layout.text = BX.create("span", {
							props: {
		...
		setText: function (t) {
			if (BX.type.isString(t)) {
				this.text = t;
				this.getTextContainer().innerHTML = t
			}
		},
		...
		addSubMenu: function (t) {
			...
			var e = this.getMenuWindow().getRootMenuWindow() || this.getMenuWindow();
			var i = e.params;
			i.autoHide = false;
			i.menuShowDelay = this.menuShowDelay;
			i.cacheable = this.isCacheable();
			i.zIndexAbsolute = this.getMenuWindow().getPopupWindow().getZindex() + 2;
			i.bindOptions = {
				forceTop: true,
				forceLeft: true,
			...
			delete i.angle;
			delete i.overlay;
			this.subMenuWindow = new BX.PopupMenuWindow("popup-submenu-" + this.id, this.layout.item, t, i);
		...
		adjustSubMenu: function () {
			...
			var t = this.subMenuWindow.getPopupWindow();
			var e = this.layout.item.getBoundingClientRect();
			var i = e.width + this.subMenuOffsetX;
			var n = e.height + this.getPopupPadding();
			var o = e.height / 2 - this.getPopupPadding();
			var s = "left";
			var p = t.getPopupContainer().offsetWidth;
			var u = t.getPopupContainer().offsetHeight;
			var a = e.top + u;
			var r = document.documentElement.clientWidth;
			var l = document.documentElement.clientHeight;
			var h = a - l;
			if (h > 0) {
				var d = Math.ceil(h / e.height) * e.height;
				if (d > e.top) {
					d -= Math.ceil((d - e.top) / e.height) * e.height
				}
				if (e.bottom > a - d) {
					d -= e.bottom - (a - d) + this.getPopupPadding()
				}
				n += d;
				o += d
			}
			if (e.left + i + p > r) {
				var f = e.left - p - this.subMenuOffsetX;
				if (f > 0) {
					i = -p - this.subMenuOffsetX;
					s = "right"
				}
			}
	...
	t.BXInputPopup = function (t) {
		...
		if (this.bValues) {
			...
			this.pInput.onblur = function () {
				if (e.bShowed) setTimeout(function () {
					e.ClosePopup(true)
				}, 200);
				e.OnChange()
			}
	...
	BXInputPopup.prototype = {
		ShowPopup: function () {
			...
			if (!this.oPopup) {
				...
				for (var n = 0, o = this.values.length; n < o; n++) {
					e = i.appendChild(BX.create("DIV", {
						props: {
							id: "bxecmr_" + n
						},
						text: this.values[n].NAME,
						events: {
							mouseover: function () {
					...
					if (this.values[n].DESCRIPTION) e.title = this.values[n].DESCRIPTION;
					if (this.values[n].CLASS_NAME) BX.addClass(e, this.values[n].CLASS_NAME);
					if (this.values[n].URL) e.appendChild(BX.create("A", {
						props: {
							href: this.values[n].URL,
		...
		OnChange: function () {
			...
			if (isNaN(parseInt(this.curInd)) || this.curInd !== false && t != this.values[this.curInd].NAME) this.curInd = false;
			else this.curInd = parseInt(this.curInd);
		...
		Set: function (t, e, i) {
			this.curInd = t;
			if (this.curInd !== false) this.pInput.value = this.values[this.curInd].NAME;
			else this.pInput.value = e;
			if (i !== false) this.OnChange()
		},
		Get: function (t) {
			var e = false;
			if (typeof t == "undefined") t = this.curInd;
			if (t !== false && this.values[t]) e = this.values[t].ID;
			return e
		},
		GetIndex: function (t) {
			for (var e = 0, i = this.values.length; e < i; e++)
				if (this.values[e].ID == t) return e;
			return false
		},
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:53:"/bitrix/js/main/core/core_date.min.js?155775558524926";s:6:"source";s:33:"/bitrix/js/main/core/core_date.js";s:3:"min";s:37:"/bitrix/js/main/core/core_date.min.js";s:3:"map";s:37:"/bitrix/js/main/core/core_date.map.js";}"*/
(function () {
	if (BX.date) return;
	...
	BX.CalendarPeriod = {
		...
		OnChangeP: function (e) {
			...
			o.style.display = s ? "inline-block" : "none";
			l.style.display = i ? "inline-block" : "none";
		...
		OnChangeD: function (e) {
			...
			switch (i.value) {
				case "day":
					r = new Date(p, c, h + n, 0, 0, 0);
					o = new Date(p, c, h + n, 23, 59, 59);
					break;
				case "week":
					r = new Date(p, c, h - u + 1 + n * 7, 0, 0, 0);
					o = new Date(p, c, h + (7 - u) + n * 7, 23, 59, 59);
					break;
				case "month":
					r = new Date(p, c + n, 1, 0, 0, 0);
					o = new Date(p, c + 1 + n, 0, 23, 59, 59);
					break;
				case "quarter":
					var d = Math.floor(c / 3) + n;
			...
			if (o) {
				s.value = BX.formatDate(o, m);
				BX.addClass(s, "adm-calendar-inp-setted")
			}
		}
	};
	BX.JCCalendar = function () {
		...
		this._create = function (e) {
			this.popup = new BX.PopupWindow("calendar_popup_" + this.control_id, e.node, {
				closeByEsc: true,
				autoHide: false,
		...
		this._check_time = function (e, t, a) {
			var s = parseInt(this.PARTS.TIME_INPUT_H.value.substring(0, 5), 10) || 0,
				i = parseInt(this.PARTS.TIME_INPUT_M.value.substring(0, 5), 10) || 0,
				n = false;
			if (!!e && !e.bSaveValue) {
				this.value.setUTCHours(this.value.getUTCHours() + a)
			} else if (!isNaN(s)) {
				if (this.bAmPm) {
					if (s != 12 && this.PARTS.TIME_AMPM.innerHTML == "PM") {
						s += 12
					}
				}
				n = true;
				this.value.setUTCHours(s % 24)
			}
			if (!isNaN(i)) {
				n = true;
				this.value.setUTCMinutes(i % 60)
			}
			if (n) {
		...
		this._set_layer = function () {
			...
			if (this._current_layer) {
				...
				if (s) {
					BX.addClass(s, "bx-calendar-active")
				}
		...
		this._create_layer = function () {
			...
			var s = this.value.getUTCMonth(),
				i = this.value.getUTCDate(),
				n = "";
			for (var r = 0; r < this.numRows; r++) {
				...
				for (var o = 0; o < 7; o++) {
					...
					if (s != t.getUTCMonth()) p += " bx-calendar-date-hidden";
					else if (i == a) p += " bx-calendar-active";
		...
		this._menu_month = function () {
			if (!this.popup_month) {
				this.popup_month = new BX.PopupWindow("calendar_popup_month_" + this.control_id, this.PARTS.MONTH, {
		...
		this._menu_year = function () {
			if (!this.popup_year) {
				this.popup_year = new BX.PopupWindow("calendar_popup_year_" + this.control_id, this.PARTS.YEAR, {
	...
	BX.JCCalendar.prototype.Show = function (e) {
		...
		var s = !!this.params.bHideTime;
		if (this.params.value) {
			this.SetValue(this.params.value);
			s = this.value.getUTCHours() <= 0 && this.value.getUTCMinutes() <= 0
		...
		if (!!this.params.bTime) BX.removeClass(this.DIV, "bx-calendar-time-disabled");
		else BX.addClass(this.DIV, "bx-calendar-time-disabled");
		if (!!s) BX.removeClass(this.PARTS.TIME, "bx-calendar-set-time-opened");
	...
	BX.JCCalendar.prototype.SaveValue = function () {
		...
		if (e) {
			...
			if (this.params.field) {
				var s = BX.message(a ? "FORMAT_DATETIME" : "FORMAT_DATE");
				if (a && !this.params.bUseSecond) {
					s = s.replace(":SS", "")
				}
				this.params.field.value = BX.calendar.ValueToStringFormat(this.value, s, true);
...
/* End */
;; /* Start:"a:4:{s:4:"full";s:44:"/bitrix/js/main/utils.min.js?155775558519858";s:6:"source";s:24:"/bitrix/js/main/utils.js";s:3:"min";s:28:"/bitrix/js/main/utils.min.js";s:3:"map";s:28:"/bitrix/js/main/utils.map.js";}"*/
var phpVars;
if (!phpVars) {
	phpVars = {
	...
	FindChildObject: function (e, t, n, i) {
		...
		for (var l = 0; l < r; l++) {
			...
			if (a.tagName && a.tagName.toUpperCase() == o)
				if (!n || a.className.toLowerCase() == s) return a;
			if (i == true) {
				var d;
				if (d = jsUtils.FindChildObject(a, t, n, true)) return d
			}
		}
		return null
	},
	FindParentObject: function (e, t, n) {
		...
		while (i.parentNode) {
			...
			if (r.tagName && r.tagName.toUpperCase() == o)
				if (!n || r.className.toLowerCase() == s) return r;
			i = r
		}
		return null
	},
	...
	loadJSFile: function (e, t, n) {
		...
		var o = function (t) {
			...
			s.onload = s.onreadystatechange = function () {
				if (!r && (!s.readyState || s.readyState == "loaded" || s.readyState == "complete")) {
					r = true;
					setTimeout(function () {
						o(++t)
					}, 50)
		...
		if (t) {
			for (s in t) {
				if (s == "className" || s == "class") {
					...
					if (jsUtils.IsIE()) o.setAttribute("className", t[s]);
					continue
				}
				if (t[s] != undefined && t[s] != null) o.setAttribute(s, t[s])
			}
		}
		if (n) {
			for (s in n) o.style[s] = n[s]
		}
		return o
	},
	in_array: function (e, t) {
...
function JCFloatDiv() {
		...
		if (i > 0) {
			...
			if (!a) {
				if (jsUtils.IsIE()) {
					...
					a.style.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/bitrix/themes/" + phpVars.ADMIN_THEME_ID + "/images/shadow.png',sizingMethod='scale')"
				} else {
					a = document.createElement("IMG");
					a.src = "/bitrix/themes/" + phpVars.ADMIN_THEME_ID + "/images/shadow.png"
				}
				a.id = e.id + "_shadow";
	...
	this.Move = function (e, t, n) {
		...
		if (e.restrictDrag) {
			...
			var r = e.offsetWidth;
			if (o > windowWidth - r - i) o = windowWidth - r - i;
			if (s < 0) s = 0
		}
		e.style.left = o + "px";
		e.style.top = s + "px";
...
BXHint.prototype.Create = function (e, t, n) {
	...
	if (n) {
		...
		if (n.height) s = n.height;
		if (n.className) r = n.className;
...
BXHint.prototype.Show = function (e, t, n, i) {
	...
	if (t && this.bWidth) r.style.width = t + "px";
	if (n) r.style.height = n + "px";
	r.innerHTML = e;
	var l = r.offsetWidth;
...
var jsSelectUtils = {
	addNewOption: function (e, t, n, i, o) {
		var s = typeof e == "string" || e instanceof String ? document.getElementById(e) : e;
		if (s) {
			var r = s.length;
			if (o !== false) {
				for (var l = 0; l < r; l++)
					if (s[l].value == t) return
			}
	...
	addSelectedOptions: function (e, t, n, i) {
		...
		var o = e.length;
		for (var s = 0; s < o; s++)
			if (e[s].selected) this.addNewOption(t, e[s].value, e[s].text, i, n)
	},
	moveOptionsUp: function (e) {
		if (!e) return;
		var t = e.length;
